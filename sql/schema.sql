...
CREATE TABLE "EDUTECH".DBO.MODULOS (
    ...
    CONSTRAINT UNIQUE (ID_CURSO, ORDEM)
);
...
CREATE TABLE "EDUTECH".DBO.AULAS (
    ...
    CONSTRAINT UNIQUE (ID_MODULO, ORDEM)
);
...
CREATE TABLE "EDUTECH".DBO.MATRICULAS (
    ...
    CONSTRAINT UNIQUE (ID_ALUNO, ID_CURSO, ID_STATUS)
);
...
CREATE TABLE "EDUTECH".DBO.PROGRESSO_AULAS (
    ...
    CONSTRAINT UNIQUE (ID_AULA, ID_MATRICULA)
);
...
CREATE TABLE "EDUTECH".DBO.AVALIACOES (
    ...
    CONSTRAINT INTERVALO_NOTA CHECK (NOTA >= 1 AND NOTA <= 5)
);
